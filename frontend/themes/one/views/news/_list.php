...
echo Html::beginTag('a',['class'=>'col-xs-3 news','href'=>Url::toRoute(['/news/view','id'=>$model->id])]);
    echo Html::beginTag('div',['class'=>'well']);
        echo Html::beginTag('div',['class'=>'news-block']);
            ...
            echo Html::tag('div',Html::img($img->getUrl('x250'),['alt' => $model->title, 'class' => 'img-responsive']),['class'=>'text-center news-img']);
...
//            echo Html::endTag('div');
//            echo Html::beginTag('div',['class'=>'col-sm-6 col-md-8 news-index-descr']);
